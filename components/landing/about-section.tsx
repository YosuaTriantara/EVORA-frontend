      ...
      <div className="container mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="lg:w-1/2">
          ...
          <div className="mt-8 pt-8 border-t border-red-900/50 flex flex-col sm:flex-row gap-6 md:gap-8">
            <div>
                <h4 className="text-white-500 font-bold text-lg mb-1">Administrasi Digital</h4>
                <p className="text-sm text-red-300">Paperless Registration</p>
            </div>

            <div>
                <h4 className="text-white-500 font-bold text-lg mb-1">Kendali Terpusat</h4>
        ...
        <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl border border-red-200 text-red-950 col-span-1 sm:col-span-2">
              <div className="flex items-center justify-between">
                  ...
                  <div className="text-3xl md:text-4xl opacity-50 text-red-500">
